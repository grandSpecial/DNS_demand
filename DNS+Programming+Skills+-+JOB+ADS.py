...
load_more_jobs_a = driver.find_elements_by_class_name("load_more_jobs")
...
for a in soup.find_all('a',{'href':re.compile('https://opportunities.digitalnovascotia.com/')}):
    links.append(a['href'])

# number of job postings 
print(f'number of jobs: {len(links)}')
